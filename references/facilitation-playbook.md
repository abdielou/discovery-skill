...
Deliver all of them in ASD-STE100 Simplified Technical English (see the main SKILL.md, Language and Style): short sentences, active voice, one term for one concept. Keep the explorer's own terms when you reflect back.
...
This isn't about rejecting analogy — it's about making sure it's a *deliberate* choice rather than an unexamined default. For deep or contentious cases, use dialectic stress-testing — read the relevant Socrates protocol file and execute it inline (see Setup in the main SKILL.md for paths).
